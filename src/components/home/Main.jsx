        ...
        <>
            <div>
                <section className='hero'>
                    ...
                    {/* Additional Section */}
                    <section className="px-[10vw]  bg-white rounded-t-[3rem] ">
                        <section className="py-[10vh] font-baloo " id='about'>
                            ...
                            <p className=" text-likeblack font-sans  text-center text-[18px] font-bold  ">À propos d'<span className=''>AC CENTER</span></p>
